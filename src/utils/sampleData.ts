...
export const SAMPLE_DATASETS: SampleDataset[] = [
  {
    ...
    csvContent: `Location ID,Custom ID (from Locations),Schedule Order,Technician,TechEmail,Setup Before,Teardown After,Battery Change/Equipment Check 1,Battery Change/Equipment Check 2,Service Type,Service Type Add Ons (from Project ID) (from Locations),City, State,Camera Counts,Backup Units,Schedule Notes,Schedule Details,Teardown Time Notes,Days of collection
26-530019-001,111223344,1,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Pedestrians,Bicycles,Passenger Vehicles (FHWA 1-3),Buses (FHWA 4),Heavy Trucks (FHWA 5+),Lafayette, LA,3 cameras,,,1-day collection,,
26-530020-001,222334455,2,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Pedestrians,Bicycles,Passenger Vehicles (FHWA 1-3),Buses (FHWA 4),Heavy Trucks (FHWA 5+),New Iberia, LA,1 camera,1 backup,East corner pole,1-day collection,,
26-530020-002,222334456,4,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Pedestrians,Bicycles,Passenger Vehicles (FHWA 1-3),Buses (FHWA 4),Heavy Trucks (FHWA 5+),New Iberia, LA,1 camera,1 backup,West leg light pole,1-day collection,,
26-530020-003,222334457,3,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Pedestrians,Bicycles,Passenger Vehicles (FHWA 1-3),Buses (FHWA 4),Heavy Trucks (FHWA 5+),New Iberia, LA,1 camera,1 backup,,1-day collection,,
26-230024-001,333445566,5,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Volume,Houma, LA,1 camera,1 backup,,1-day collection,,
26-460059-001,444556677,6,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${friDate} 00:30,,,ALG,Volume,Leander, TX,1 camera,1 backup,East corner pole,1 Day: Tue/Wed/Thu = TBD,,1-day
26-470265-001,555667788,7,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${wedDate} 0:30,,,Near Miss Study,Vehicle to Vehicle,Dallas, TX,0 cameras,,,Data being collected by 26-470263-001,1-day collection,,
26-470265-002,555667789,8,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${wedDate} 0:30,,,Near Miss Study,Vehicle to Vehicle,Dallas, TX,0 cameras,,,Data being collected by 26-470263-002,1-day collection,,
26-450228-001,666778899,9,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${thuDate} 19:00,,,TMC,Pedestrians,Bicycles,Passenger Vehicles (FHWA 1-3),Heavy Trucks (FHWA 4+),Huffman, TX,1 camera,1 backup,North corner pole,,,
26-450227-001,777889900,10,Devon Washington,devon.washington@ndsdata.com,${monDate} 10:30,${thuDate} 19:30,,,TMC,Heavy Trucks (FHWA 4+),Houston, TX,1 camera,1 backup,Median post,,,
26-450218-001,888990011,11,Devon Washington,devon.washington@ndsdata.com,${monDate} 08:00,${wedDate} 18:30,,,TMC,Heavy Trucks (FHWA 4+),Houston, TX,4 cameras,,West leg light pole,1 Day: Tue/Wed = TBD,,
26-104822-001,999001122,1,Devon Washington,devon.washington@ndsdata.com,${tueDate} 08:00,${wedDate} 14:00,,,Miovision,,Dallas, TX,2 cameras,1 backup,,,,
26-104845-001,101112131,,Devon Washington,devon.washington@ndsdata.com,,${tueDate} 14:00,,,Miovision,,Fort Worth, TX,0 cameras,,,Anytime,
26-104899-001,121314151,,Devon Washington,devon.washington@ndsdata.com,,,${wedDate} 10:00,,Miovision,,Plano, TX,4 cameras,,,,3-day
26-104910-001,131415161,,Devon Washington,devon.washington@ndsdata.com,,${thuDate} 10:00,,,Miovision,,Irving, TX,2 cameras,,,,
26-450222-001,141516171,1,Devon Washington,devon.washington@ndsdata.com,${friDate} 08:00,${satDate} 14:00,,,Miovision,ATR Volume,Houston, TX,2 cameras,,,,,
26-104950-001,151617181,2,Devon Washington,devon.washington@ndsdata.com,${friDate} 07:00,,,,Miovision,ATR,Arlington, TX,2 cameras,,,,
26-204100-001,161718191,1,Alexander Shaw,alexander.shaw@ndsdata.com,${monDate} 08:00,${thuDate} 16:00,${tueDate} 09:00,,Miovision,,Houston, TX,3 cameras,,,,3-day
26-204110-001,171819201,,Miguel Hendry,miguel.hendry@ndsdata.com,,${wedDate} 11:30,,,Miovision,,Pasadena, TX,1 camera,,,Anytime,
26-304200-001,181920211,1,Madison Lopez,madison.lopez@ndsdata.com,${tueDate} 08:00,${friDate} 15:00,${wedDate} 10:00,,Miovision,,Austin, TX,2 cameras,,,,5-day
26-304210-001,192021221,,Joshua McDougal,joshua.mcdougal@ndsdata.com,,${thuDate} 09:00,,,Miovision,,Round Rock, TX,2 cameras,,,Anytime,
26-404300-001,202122231,1,Damian Palmer,damian.palmer@ndsdata.com,${monDate} 08:00,${friDate} 16:30,,,Miovision,,San Antonio, TX,4 cameras,,,,
26-404305-001,212223241,2,Anthony Ferrell,anthony.ferrell@ndsdata.com,${wedDate} 08:30,,,,Miovision,Radar,New Braunfels, TX,2 cameras,,,,
26-410095-001,222324251,1,Giovonn Robinson,giovonn.robinson@ndsdata.com,${monDate} 08:00,${thuDate} 17:00,,,TMC,Volume,Fort Worth, TX,2 cameras,,Conduct Study: 24-hr count,1-day collection,,
26-410098-001,252627281,1,James Londeree,james.londeree@ndsdata.com,${wedDate} 08:00,${friDate} 17:00,,,Miovision,,Longview, TX,3 cameras,,,,
26-410099-001,262728291,1,Aria Ghiorbani,aria.ghiorbani@ndsdata.com,${monDate} 08:00,${thuDate} 18:00,,,Miovision,,Beaumont, TX,2 cameras,1 backup,Median post,,,`
  },
  {
    id: "hvac_service",
