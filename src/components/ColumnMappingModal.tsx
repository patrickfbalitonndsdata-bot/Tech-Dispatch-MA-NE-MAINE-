...
const FIELD_LABELS: { key: keyof ColumnMapping; label: string; description: string; required: boolean }[] = [
  ...
  { key: "customId", label: "Custom ID (from Locations)", description: "Custom identifier from CSV (e.g. 111223344) placed beside location suffix (• 001 (111223344))", required: false },
  ...
  { key: "scheduleNotes", label: "Schedule Notes", description: "Location schedule notes e.g. (Near NW light pole) appended in location bullet", required: false },
